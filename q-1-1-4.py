...
y_pred_tr_agg = list(agg.fit_predict(X_train))
y_pred_vd_agg = list(agg.fit_predict(X_valid))
y_pred_ts_agg = list(agg.fit_predict(X_test_reduced))

train_purity = compute_purity(y_train, y_pred_tr_agg, y_train, y_pred_tr_agg, 'xAttack')
valid_purity = compute_purity(y_train, y_pred_tr_agg, y_valid, y_pred_vd_agg, 'xAttack')
